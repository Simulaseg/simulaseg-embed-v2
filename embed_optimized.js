/**
 * SimulaSeg Embed Script - Optimized Version 20250607
 * US Version with dollar values and US states
 * Enhanced with better error handling and CDN optimization
 * 
...
(function() {
    ...
    debugLog('Initializing SimulaSeg Embed (JSDelivr Optimized Version)');

    // Get script element and data attributes
    const scripts = document.getElementsByTagName('script');
    const script = scripts[scripts.length - 1];

    // Enhanced API URL detection with direct Replit URL
